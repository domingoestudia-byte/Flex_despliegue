          ...
          <div className="space-y-3 mb-5">
            ...
            <ol className="space-y-2 text-sm text-zinc-300">
              <li className="flex items-start gap-2">
                ...
                <span>Toca el botón de compartir <span className="inline-block align-middle text-amber-400">⬆</span> en Safari</span>
              </li>
              <li className="flex items-start gap-2">
        ...
        <div className="flex gap-3">
          {!isIos && (
            <button
              ...
              className="flex-1 py-2.5 bg-amber-500 hover:bg-amber-600 text-zinc-950 font-bold text-sm rounded-xl transition-colors"
            >
              Instalar
            </button>
          )}
